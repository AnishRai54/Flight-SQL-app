...
aeroplane_detail;""")
    ...
    def Early_Morining_departure(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where departure_time="Early_Morining" ;""")

        data=self.mycursor.fetchall()

        return data

    def Afternoon_departure(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where departure_time="Afternoon" ;""")

        data=self.mycursor.fetchall()

        return data

    def Late_Night_departure(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where departure_time="Late_Night" ;""")
    ...
    def evening_Arrival(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where arrival_time="Evening" ;""")

        data=self.mycursor.fetchall()

        return data

    def Morning_Arrival(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where arrival_time="Morning" ;""")

        data=self.mycursor.fetchall()

        return data

    def Night_Arrival(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where arrival_time="Night" ;""")

        data=self.mycursor.fetchall()

        return data

    def Early_Morining_Arrival(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where arrival_time="Early_Morining" ;""")

        data=self.mycursor.fetchall()

        return data

    def Afternoon_Arrival(self):
    ...
    def Late_Night_Arrival(self):

        self.mycursor.execute(""" 
        select * from aeroplane_detail 
        where arrival_time="Late_Night" ;""")
